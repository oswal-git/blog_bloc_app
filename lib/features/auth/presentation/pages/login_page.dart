...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    // final bool appUserLoggedInState = context.watch<AppUserCubit>().state is AppUserLoggedInState;
                  ...
                  AuthGradientButton(
                    ...
                    onPressed: () {
                      if (formKey.currentState!.validate()) {
                        context
                            .read<AuthBloc>()
                            .add(AuthLoginEvent(email: emailController.text.trim(), password: passwordController.text.toString()));
                      }
                    },
                  ),
                  const SizedBox(height: 20),
